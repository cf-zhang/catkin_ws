    ...
    QDialog(parent)
{
    ...
    try{
        rsa = new TRsa("/home/ld/jdcart_ws/src/button_control/rsakey.pub",
                    "/home/ld/jdcart_ws/src/button_control/rsakey");
        //read the rememberMe file for editLine;
        rememberMeFile = "/home/ld/jdcart_ws/src/button_control/remebered";
        loadRememberedAccount();
    }
    catch(std::exception& ex){
        printf("Error loading rsa files.");
    }
    ...
    db.setDatabaseName("/home/ld/jdcart_ws/my.db");
    if (!db.open())
    {
